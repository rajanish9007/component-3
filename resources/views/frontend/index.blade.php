            ...
            <div class="col-md-4" style="position: fixed;right:0">
                ...
                <form action="{{ route('shop.store') }}" method="POST">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="title" id="title"
                                placeholder="Enter Title" value="{{ old('producttype') }}">
                            <div class="text-danger">{{ $errors->first('title') }}</div>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="firstname">AUTHOR/PRODUCER</label>
                    ...
                    <div class="form-group">
                        <label for="surname">Publisher/Distributer</label>
                        <input type="text" class="form-control" name="surname" id="surname"
                            value="{{ old('surname') }}" placeholder="Enter Name">
